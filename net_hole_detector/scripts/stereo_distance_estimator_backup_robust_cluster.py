...
# ==========================================================
DEFAULT_MIN_VALID_MASK_PIXELS = 10
...
DEFAULT_DILATION_KERNEL_SIZE = 63
...
class StereoDistanceEstimator:
    ...
    def __init__(self):
        ...
        # Subscribers
        rospy.Subscriber("/masked_stereo/disparity", DisparityImage, self.callback_disparity)

        sub_points = Subscriber("/masked_stereo/points2", PointCloud2)
        ...
        rospy.loginfo("[StereoDistanceEstimator] Listening points: /masked_stereo/points2")
    ...
    def callback_distance(self, msg_point2, msg_bb, msg_mask):
        ...
        try:
            ...
            rospy.logerr(f"[StereoDistanceEstimator] Error leyendo /masked_stereo/points2: {e}")
            return
        ...
        for bb in msg_bb.boxes:
            ...
            distance_raw = float(np.percentile(valid_depths, 5))
